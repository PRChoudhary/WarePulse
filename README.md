...
## Introduction
This project is a **Real-Time Inventory Management System(IMS)** designed to track and update inventory levels for businesses in real time. It includes role-based access for **Admins** and **Employees**, providing features like inventory tracking, stock movement analysis, and low-stock alerts. The system is built using the **MERN stack** (MongoDB, Express.js, React.js, and Node.js).
